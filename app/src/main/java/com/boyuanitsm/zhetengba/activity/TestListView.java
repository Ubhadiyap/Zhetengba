        ...
        bt_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bt_message.getText().equals("加为好友")) {
                    ...
                    final Intent intent = new Intent(TestListView.this, ChatActivity.class);
                ...
                if (userinfo != null) {
                    if (userinfo.getUserType() != null) {
                        ...
                        if (usertype.equals("1")) {
                            Intent intent = new Intent(TestListView.this, MessVerifyAct.class);
                            Bundle bundle = new Bundle();
...
//                toPageCalFrg();
                ...
                setOnclikListener();
                hlv_perpage.setAdapter(new HlvppAdapter(TestListView.this, circleEntity));//她的圈子下面水平view适配器
                hlv_perpage.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent = new Intent(TestListView.this, CircleglAct.class);
                        Bundle bundle = new Bundle();
    ...
    private void setSelect(int position, List<UserInfo> userEntity, List<ScheduleInfo> scheduleEntity, List<CircleEntity> circleTalkEntity) {
        ...
        switch (position) {
            case 0://档期frg
                setTab(0);
                    if (adapter==null){
                        adapter=new TestAdapter(TestListView.this,userEntity,scheduleEntity,circleTalkEntity,0,datalist);
            ...
            case 1://圈子动态frg
                setTab(1);
                if (adapter==null){
                    adapter=new TestAdapter(TestListView.this,userEntity,scheduleEntity,circleTalkEntity,1,datalist);
                    test_lv.setAdapter(adapter);
                }else {
            ...
            case 2:
                setTab(0);
                if (adapter==null){
                    adapter=new TestAdapter(TestListView.this,userEntity,scheduleEntity,circleTalkEntity,2,datalist);
                    test_lv.setAdapter(adapter);
                }else {
    ...
    private void setOnclikListener() {
        cv_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentPerson.setClass(TestListView.this, PersonalmesAct.class);
        ...
        if (str.size() == 0) {
            ...
            tv_tab5.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(TestListView.this, LabelMangerAct.class);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
            });
    ...
    private void showPopupWindow(View parent) {
        ...
        WindowManager manager = (WindowManager) getSystemService(TestListView.this.WINDOW_SERVICE);
        ...
        ll_schy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MyAlertDialog(TestListView.this).builder().setTitle("提示").setMsg("确定删除该好友").setPositiveButton("确定", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
        ...
        ll_hei.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MyAlertDialog(TestListView.this).builder().setTitle("提示").setMsg("确定加入黑名单").setPositiveButton("确定", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //加入黑名单接口
