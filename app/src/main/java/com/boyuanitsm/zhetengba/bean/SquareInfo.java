...
public class SquareInfo implements Parcelable {
    ...
    public static Creator<SquareInfo> getCREATOR() {
        return CREATOR;
    }
    ...
    protected SquareInfo(Parcel in) {
    ...
    public static final Creator<SquareInfo> CREATOR = new Creator<SquareInfo>() {
        @Override
        public SquareInfo createFromParcel(Parcel source) {
            return new SquareInfo(source);
        }

        @Override
        public SquareInfo[] newArray(int size) {
            return new SquareInfo[size];
        }
    };
}
