...
package com.boyuanitsm.zhetengba.view.scan;
...
/**
 * This view is overlaid on top of the camera2 preview. It adds the viewfinder
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        int center = Color.parseColor("#30b5c8");
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            paint.setColor(Color.parseColor("#0cc207"));
            // 画出四个角
