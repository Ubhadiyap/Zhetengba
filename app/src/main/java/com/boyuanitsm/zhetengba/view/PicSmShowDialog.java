...
/**
 * 这里的跟picShowDialog其实一样只是前面的显示大图片 这里显示小的图片。
 * 之所以重写是因为很多地方已经用了大图片所以不想在picShowDialog构造方法中在去修改
 *
 * Created by bitch-1 on 2016/11/4.
 */
...
//    .showImageOnLoading(R.mipmap.banner_loading)
    ...
    public PicSmShowDialog(Context context, int themeResId) {
        super(context, themeResId);
        this.context = context;
    }


    public PicSmShowDialog(Context context, String[] imageInfos, int position) {
