...
//        View headView=View.inflate(context,R.layout.mess_head_view,null);
//        TextView tvmessage= (TextView) headView.findViewById(R.id.message);
//        TextView tvUnReadNum= (TextView) headView.findViewById(R.id.unread_msg_number);
//        if(num>0){
