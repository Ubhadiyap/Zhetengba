...
public class EaseChatInputMenu extends LinearLayout {
    ...
    protected EaseSwitchButton switch_btn;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        chatExtendMenuContainer = (RelativeLayout) findViewById(R.id.extend_menu_container);
        ...
        switch_btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (switch_btn.isSwitchOpen()) {
                    switch_btn.closeSwitch();
                    if(setSwitch!=null){
                        setSwitch.getIsSwitch(false);
                    }
                } else {
                    switch_btn.openSwitch();
                    if(setSwitch!=null){
                        setSwitch.getIsSwitch(true);
                    }
                }
            }
        });
    ...
    public void setSwitchIsOn(boolean isSwitchOn){
        if(isSwitchOn){
            switch_btn.openSwitch();
        }else{
            switch_btn.closeSwitch();
    ...
    private SetSwitch setSwitch;

    public SetSwitch getSetSwitch() {
        return setSwitch;
    }

    public void setSetSwitch(SetSwitch setSwitch) {
            ...
            handler.postDelayed(new Runnable() {
                public void run() {
                    ...
                    if (chatType == EaseConstant.CHATTYPE_SINGLE)
                        rlRead.setVisibility(VISIBLE);
                    else
                        rlRead.setVisibility(GONE);
